      ...
      <Show when={enabled()}>
        <Dynamic component={props.fixed ? Portal : Fragment}>
          <div
            ...
            class={clsx(
              `:base: text-sm whitespace-nowrap py-0.5 px-1 leading-none transition-transform transform dark:bg-gray-200 dark:text-gray-800 rounded-md bg-gray-800 text-gray-50 z-40 pointer-events-none`,
              {
