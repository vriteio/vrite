...
const buttonColorsVariantsHover = {
  primaryText: ` :base-2: hover:font-bold hover:text-current hover:bg-clip-border hover:text-white dark:hover:text-current dark:hover:bg-clip-border dark:hover:text-white`,
