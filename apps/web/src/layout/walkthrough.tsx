      ...
      <Presence exitBeforeEnter>
        <Show when={activeWalkthrough()}>
          <Motion
            ...
            class="origin-bottom-right fixed bottom-8 right-2 z-100"
          >
            <Card
              class="p-0 relative overflow-hidden flex flex-col shadow-2xl"
              style={{
                width: `${width()}px`,
                height: `${height()}px`
              }}
            >
              <div class="h-12 w-full flex justify-start items-center px-2">
                <Tooltip text="Resize" side="right" class="ml-1">
                  <IconButton
                ...
                <div class="flex-1" />
                <Tooltip text="Close" side="left" class="-ml-1">
                  <IconButton
                    onClick={() => {
