import { Button, Card, createRef, Dialog, IconButton, ScrollShadow } from "@andesine/components";
...
const ActionConfirmationDialog: Component<ActionConfirmationDialogProps> = (props) => {
  ...
  return (
    <Dialog opened={props.opened} onOverlayClick={props.onClose} portal aria-label={props.title}>
