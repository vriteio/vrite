...
const RotateKeyDialog: Component<RotateKeyDialogProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Card class="flex items-center gap-1 rounded-lg border-0 px-1 py-0.5 h-8" color="contrast">
        ...
        <div class="flex items-center flex-1 gap-1.5">
          ...
          <span class="text-xs shrink-0 font-mono text-gray-400">{visibleKey()?.prefix}...</span>
        </div>
      </Card>
      <p class="text-sm leading-tight text-gray-400">
