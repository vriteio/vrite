...
(() => {
  ...
  var o, P, p, w, k, u, U, n, f, S, D, c, L, O, x, $, j, y, R, C, g, I, E, v, q;
  var init_api = __esm({
    "../../packages/sdk/javascript/dist/api.mjs"() {
      o = "/content-groups";
      P = (t) => ({ get: (e) => t("GET", `${o}`, { params: e }), list: (e) => t("GET", `${o}/list`, { params: e }), create: (e) => t("POST", `${o}`, { body: e }), update: (e) => t("PUT", `${o}`, { body: e }), delete: (e) => t("DELETE", `${o}`, { params: e }) });
      p = "/content-pieces";
      w = (t) => ({ get: (e) => t("GET", `${p}`, { params: e }), create: (e) => t("POST", `${p}`, { body: e }), update: (e) => t("PUT", `${p}`, { body: e }), delete: (e) => t("DELETE", `${p}`, { params: e }), list: (e) => t("GET", `${p}/list`, { params: e }) });
      k = (t) => {
        let e = t.baseURL || "https://api.vrite.io", s = t.extensionId || "", r = t.headers || {}, { token: l } = t;
        return { sendRequest: async (a, h, i) => {
          try {
            const { default: d } = await Promise.resolve().then(() => __toESM(require_browser(), 1)), b = await d(`${e}${h}/?${encodeURI(Object.entries(i?.params || {}).filter(([, m]) => m).map(([m, G]) => `${m}=${G}`).join("&"))}`, { headers: { Authorization: `Bearer ${l}`, Accept: "application/json", ...i?.body ? { "Content-Type": "application/json" } : {}, ...s ? { "X-Vrite-Extension-ID": s } : {}, ...r }, body: i?.body ? JSON.stringify(i.body) : null, method: a });
            let T = null;
            try {
              if (T = await b.json(), !T)
                return;
          ...
          e = a.baseURL || e, l = a.token || l, s = a.extensionId || s, r = a.headers || r;
        } };
      };
      u = "/user-settings";
      U = (t) => ({ get: () => t("GET", `${u}`), update: (e) => t("PUT", `${u}`, { body: e }) });
      n = "/tags";
      f = (t) => ({ get: (e) => t("GET", `${n}`, { params: e }), update: (e) => t("PUT", `${n}`, { body: e }), create: (e) => t("PUT", `${n}`, { body: e }), delete: (e) => t("DELETE", `${n}`, { params: e }), list: (e) => t("GET", `${n}/list`, { params: e }) });
      S = "/profile";
      D = (t) => ({ get: () => t("GET", `${S}`) });
      c = "/webhooks";
      L = (t) => ({ get: (e) => t("GET", `${c}`, { params: e }), create: (e) => t("POST", `${c}`, { body: e }), update: (e) => t("PUT", `${c}`, { body: e }), delete: (e) => t("DELETE", `${c}`, { params: e }), list: (e) => t("GET", `${c}/list`, { params: e }) });
      O = "/workspace";
      x = (t) => ({ get: () => t("GET", `${O}`) });
      $ = "/roles";
      j = (t) => ({ get: (e) => t("GET", `${$}`, { params: e }), create: (e) => t("POST", `${$}`, { body: e }), update: (e) => t("PUT", `${$}`, { body: e }), delete: (e) => t("DELETE", `${$}`, { params: e }), list: (e) => t("GET", `${$}/list`, { params: e }) });
      ...
      E = "/variants";
      v = (t) => ({ create: (e) => t("POST", `${E}`, { body: e }), update: (e) => t("PUT", `${E}`, { body: e }), delete: (e) => t("DELETE", `${E}`, { params: e }), list: () => t("GET", `${E}/list`) });
      q = (t) => {
        const { sendRequest: e, reconfigure: s } = k(t);
        return { contentGroups: P(e), contentPieces: w(e), tags: f(e), profile: D(e), userSettings: U(e), webhooks: L(e), workspace: x(e), roles: j(e), workspaceSettings: R(e), workspaceMemberships: C(e), extension: I(e), variants: v(e), search(r) {
          return e("GET", "/search", { params: r });
        }, reconfigure: s };
      };
    }
  });
